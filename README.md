...
- Games:
  - I wrote a game engine and used it for my first game, [Bullet Sudoku](https://github.com/rbaltrusch#bullet-sudoku), a 2D top-down platformer.
  - I have written several games for short [game jams](https://github.com/rbaltrusch#game-jam-submissions), most of which are open-sourced on Github.
